...
const { addOrders, getAllOrders, getOneOrders, editOrders, deleteOrders, paymentOrders, getAllOrdersByUser, editStatusOrder } = require('../../controllers/orders/orders_controller');
